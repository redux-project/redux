...
CNode* ConnectNode(CAddress addrConnect, const char *pszDest = NULL, bool spySendMaster=false);
...
public:
    ...
    // In this case node will be released automatically via CMasterXMan::ProcessMasterXConnections().
