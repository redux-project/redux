...
{
    if (pszDest == NULL) {
        // we clean masterx connections in CMasterXMan::ProcessMasterXConnections()
        // so should be safe to skip this and connect to local Hot MN on CActiveMasterX::ManageStatus()
        ...
        if (pnode)
        {
            pnode->fStealthXMaster = spySendMaster;
                  ...
                  ConnectSocket(addrConnect, hSocket, nConnectTimeout, &proxyConnectionFailed))
    {
        ...
        if(spySendMaster) pnode->fStealthXMaster = true;
