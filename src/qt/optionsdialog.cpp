    ...
    fProxyIpValid(true)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("REDUX-green"), QVariant("reduxred"));
    ui->theme->addItem(QString("REDUX-traditional"), QVariant("trad"));
...
void OptionsDialog::setMapper()
{
    ...
    /* StealthX Rounds */
    mapper->addMapping(ui->stealthxRounds, OptionsModel::StealthXRounds);
    mapper->addMapping(ui->anonymizeReduxcoin, OptionsModel::AnonymizeReduxcoinAmount);
