    ...
    transactionView(0)
{
    ...
    typeWidget->addItem(tr("StealthX Make Collateral Inputs"), TransactionFilterProxy::TYPE(TransactionRecord::StealthXMakeCollaterals));
    typeWidget->addItem(tr("StealthX Create Denominations"), TransactionFilterProxy::TYPE(TransactionRecord::StealthXCreateDenominations));
    typeWidget->addItem(tr("StealthX Denominate"), TransactionFilterProxy::TYPE(TransactionRecord::StealthXDenominate));
    typeWidget->addItem(tr("StealthX Collateral Payment"), TransactionFilterProxy::TYPE(TransactionRecord::StealthXCollateralPayment));
