...
void RPCConsole::setClientModel(ClientModel *model)
{
    ...
    if(model)
    {
        ...
        setMasterXCount(model->getMasterXCountString());
        connect(model, SIGNAL(strMasterXChanged(QString)), this, SLOT(setMasterXCount(QString)));
...
void RPCConsole::setMasterXCount(const QString &strMasterX)
{
    ui->masterxCount->setText(strMasterX);
}
